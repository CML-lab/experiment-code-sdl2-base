...
public:
	...
	// Draw the image
	// w and h define the dimensions to draw the image
	// centerflag says how to draw the image: 0 = centered, 1 = right-sided, -1 = left-sided
	void DrawAlign(GLfloat xPos, GLfloat yPos, GLfloat w, GLfloat h, GLfloat theta = 0.0f, GLint cflag = 0);
};
